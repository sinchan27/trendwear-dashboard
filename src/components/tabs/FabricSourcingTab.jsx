...
export default function FabricSourcingTab({ 
  fabricSourcing,
  isForecastIngested = false,
  onNavigateDataHub
}) {
  if (!isForecastIngested || !fabricSourcing || fabricSourcing.grandTotalDemand === 0) {
    return (
      <NoDataEmptyState 
        title="No Fabric Sourcing Allocation Available" 
